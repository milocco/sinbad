   ...
   */
{
 ...
 ELog::EM<<"\n "<<ELog::endBasic;
  ...
  MObj.setMaterial(1,"41MildSteel1", 
     "  6000"+ext+"  6.0509E-04 "
     " 14028"+ext+"  3.8322E-05 "
     " 14029"+ext+"  1.9576E-06 "
     " 14030"+ext+"  1.3051E-06 "
     " 25055"+ext+"  6.5848E-04 "
     " 26054"+ext+"  3.3914E-03 "
     " 26056"+ext+"  5.3238E-02 "
     " 26057"+ext+"  1.2295E-03 "
     " 26058"+ext+"  1.6361E-04 ",
 		        "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(2,"41Aluminium2",
    " 13027"+ext+"  6.0261E-02 " ,
              	         "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(3,"41Graphite",
    "  6000"+ext+"  8.2727E-02 ",
 	       "grph.20t","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(4,"41Fuel",
     " 13027"+ext+"  5.8122E-02 "
     " 92235"+ext+"  1.5550E-03 "
     " 92238"+ext+"  1.1367E-04 " ,
           	        "","");
  ...
  DBObj.resetMaterial(MObj);
  MObj.setMaterial(5,"41Aluminium5",
     " 13027"+ext+"  5.9085E-02 "
     " 14028"+ext+"  7.6592E-05 "
     " 14029"+ext+"  3.9156E-06 "
     " 14030"+ext+"  2.5511E-06 "
     " 26054"+ext+"  9.3738E-06 "
     " 26056"+ext+"  1.4696E-04 "
     " 26057"+ext+"  3.3817E-06 "
     " 26058"+ext+"  4.7462E-07 ",
                         "","");
 
  DBObj.resetMaterial(MObj);
  MObj.setMaterial(6,"41MildSteel6",
     " 26054"+ext+"  4.8479E-03 "
     " 26056"+ext+"  7.7183E-02 "
     " 26057"+ext+"  1.8144E-03 "
     " 26058"+ext+"  2.4568E-04 "
     " 25055"+ext+"  6.2757E-04 "
     "  6000"+ext+"  1.9506E-04 ",
                        "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(7,"41StainlessSteel7",
     "  6000"+ext+"  2.3816E-04 "
     " 14028"+ext+"  7.8288E-04 "
     " 14029"+ext+"  3.9817E-05 "
     " 14030"+ext+"  2.6245E-05 "
     " 15031"+ext+"  4.6178E-05 "
     " 16032"+ext+"  2.8184E-05 "
     " 16033"+ext+"  2.8920E-07 "
     " 16034"+ext+"  1.2632E-06 "
     " 24050"+ext+"  6.6810E-04 "
     " 24052"+ext+"  1.2884E-02 "
     " 24053"+ext+"  1.4610E-03 "
     " 24054"+ext+"  3.6364E-04 "
     " 25055"+ext+"  1.3625E-03 "
     " 26054"+ext+"  3.3408E-03 "
     " 26056"+ext+"  5.2444E-02 "
     " 26057"+ext+"  1.2112E-03 "
     " 26058"+ext+"  1.6122E-04 "
     " 28058"+ext+"  6.4478E-03 "
     " 28060"+ext+"  2.4837E-03 "
     " 28061"+ext+"  1.0798E-04 "
     " 28062"+ext+"  3.4421E-04 "
     " 28064"+ext+"  8.7704E-05 "
     " 42092"+ext+"  1.7995E-04 "
     " 42094"+ext+"  1.1215E-04 "
     " 42095"+ext+"  1.9306E-04 "
     " 42096"+ext+"  2.0223E-04 "
     " 42097"+ext+"  1.1581E-04 "
     " 42098"+ext+"  2.9257E-04 "
     " 42100"+ext+"  1.1677E-04 ",
             	             "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(8,"41StainlessSteel8",
     "  6000"+ext+"  3.4317E-05 "
     " 14028"+ext+"  2.4434E-04 "
     " 14029"+ext+"  1.2869E-05 "
     " 14030"+ext+"  8.7508E-06 "
     " 15031"+ext+"  3.4317E-05 "
     " 16032"+ext+"  8.1503E-06 "
     " 16033"+ext+"  8.5792E-08 "
     " 16034"+ext+"  4.2896E-07 "
     " 24050"+ext+"  6.1590E-04 "
     " 24052"+ext+"  1.2351E-02 "
     " 24053"+ext+"  1.4275E-03 "
     " 24054"+ext+"  3.6204E-04 "
     " 25055"+ext+"  1.4585E-03 "
     " 26054"+ext+"  3.3226E-03 "
     " 26056"+ext+"  5.2158E-02 "
     " 26057"+ext+"  1.2046E-03 "
     " 26058"+ext+"  1.6026E-04 "
     " 28058"+ext+"  6.8604E-03 "
     " 28060"+ext+"  2.7336E-03 "
     " 28061"+ext+"  1.2080E-04 "
     " 28062"+ext+"  3.9147E-04 "
     " 28064"+ext+"  1.0295E-04 "
     " 42092"+ext+"  2.9272E-04 "
     " 42094"+ext+"  1.8643E-04 "
     " 42095"+ext+"  3.2429E-04 "
     " 42096"+ext+"  3.4334E-04 "
     " 42097"+ext+"  1.9861E-04 "
     " 42098"+ext+"  5.0703E-04 "
     " 42100"+ext+"  2.0650E-04 ",
             	             "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(9,"41StainlessSteel9",
     "  6000"+ext+"  4.2716E-05 "
     " 14028"+ext+"  2.0410E-04 "
     " 14029"+ext+"  1.0764E-05 "
     " 14030"+ext+"  7.3471E-06 "
     " 15031"+ext+"  2.5629E-05 "
     " 16032"+ext+"  2.4262E-05 "
     " 16033"+ext+"  1.7086E-07 "
     " 16034"+ext+"  1.1960E-06 "
     " 24050"+ext+"  6.1510E-04 "
     " 24052"+ext+"  1.2335E-02 "
     " 24053"+ext+"  1.4256E-03 "
     " 24054"+ext+"  3.6155E-04 "
     " 25055"+ext+"  1.3071E-03 "
     " 26054"+ext+"  3.2334E-03 "
     " 26056"+ext+"  5.2635E-02 "
     " 26057"+ext+"  1.2373E-03 "
     " 26058"+ext+"  1.6753E-04 "
     " 28058"+ext+"  6.5330E-03 "
     " 28060"+ext+"  2.6032E-03 "
     " 28061"+ext+"  1.1508E-04 "
     " 28062"+ext+"  3.7282E-04 "
     " 28064"+ext+"  9.7990E-05 "
     " 42092"+ext+"  2.9517E-04 "
     " 42094"+ext+"  1.8795E-04 "
     " 42095"+ext+"  3.2695E-04 "
     " 42096"+ext+"  3.4617E-04 "
     " 42097"+ext+"  2.0025E-04 "
     " 42098"+ext+"  5.1122E-04 "
     " 42100"+ext+"  2.0820E-04 ",
             	             "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(10,"41StainlessSteel10",
     "  6000"+ext+"  5.1389E-05 "
     " 14028"+ext+"  2.3605E-04 "
     " 14029"+ext+"  1.2419E-05 "
     " 14030"+ext+"  8.4793E-06 "
     " 15031"+ext+"  2.5695E-05 "
     " 16032"+ext+"  1.6188E-05 "
     " 16033"+ext+"  1.7130E-07 "
     " 16034"+ext+"  7.7084E-07 "
     " 24050"+ext+"  6.2233E-04 "
     " 24052"+ext+"  1.2481E-02 "
     " 24053"+ext+"  1.4425E-03 "
     " 24054"+ext+"  3.6581E-04 "
     " 25055"+ext+"  1.4303E-03 "
     " 26054"+ext+"  3.2097E-03 "
     " 26056"+ext+"  5.2250E-02 "
     " 26057"+ext+"  1.2283E-03 "
     " 26058"+ext+"  1.6633E-04 "
     " 28058"+ext+"  6.7108E-03 "
     " 28060"+ext+"  2.6740E-03 "
     " 28061"+ext+"  1.1820E-04 "
     " 28062"+ext+"  3.8294E-04 "
     " 28064"+ext+"  1.0072E-04 "
     " 42092"+ext+"  3.0071E-04 "
     " 42094"+ext+"  1.9151E-04 "
     " 42095"+ext+"  3.3317E-04 "
     " 42096"+ext+"  3.5270E-04 "
     " 42097"+ext+"  2.0410E-04 "
     " 42098"+ext+"  5.2092E-04 "
     " 42100"+ext+"  2.1215E-04 ",
             	             "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(11,"41Concrete",
     "  1001"+ext+"  7.9500E-04 " 
     "  1002"+ext+"  1.5871E-07 " 
     "  8016"+ext+"  4.2047E-02 "
     "  8017"+ext+"  1.6982E-05 "
     //8018 added to 8017
     " 11023"+ext+"  1.2802E-03 "
     " 13027"+ext+"  2.7035E-03 "
     " 14028"+ext+"  2.4612E-02 "
     " 14029"+ext+"  1.2944E-03 "
     " 14030"+ext+"  8.8261E-04 "
     " 19039"+ext+"  1.4780E-03 "
     " 19040"+ext+"  1.5871E-07 "
     " 19041"+ext+"  1.1213E-04 "
     " 20040"+ext+"  2.9130E-03 "
     " 20042"+ext+"  2.0395E-05 "
     " 20043"+ext+"  4.3646E-06 "
     " 20044"+ext+"  6.8961E-05 "
     " 20046"+ext+"  1.5871E-07 "
     " 20048"+ext+"  6.7454E-06 "
     " 26054"+ext+"  6.3327E-05 "
     " 26056"+ext+"  1.0304E-03 "
     " 26057"+ext+"  2.4204E-05 "
     " 26058"+ext+"  3.2536E-06 ",
                	         "","");

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(101,"41S",
     " 16032"+ext+"  3.4287E-02 "
     " 16033"+ext+"  2.7450E-04 "
     " 16034"+ext+"  1.5495E-03 "
     " 16036"+ext+"  7.2236E-06 ",
  ...
  DBObj.resetMaterial(MObj);
  MObj.setMaterial(102,"41Spressed",
     " 16032"+ext+"  3.2443E-02 "
     " 16033"+ext+"  2.5974E-04 "
     " 16034"+ext+"  1.4661E-03 "
     " 16036"+ext+"  6.8352E-06 ",
  ...
  DBObj.resetMaterial(MObj);
  MObj.setMaterial(103,"41Rh",
    " 45103"+ext+"  7.2625e-02 ",
		     "",MLib);
  //  MObj.setDensity(7.2625E-02);

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(104,"41Mn",
    " 25055"+ext+"  7.9034E-02 ",
		     "",MLib);
  //  MObj.setDensity(7.9034E-02);

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(105,"41Au",
    " 79197"+ext+"  5.9009E-02 ",
		     "",MLib);
  //  MObj.setDensity(5.9009E-02);

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(106,"41Cd",
     " 48106"+ext+"  5.7925E-04 "  
     " 48108"+ext+"  4.1243E-04 "
     " 48110"+ext+"  5.7879E-03 " 
     " 48111"+ext+"  5.9315E-03 "
  ...
  DBObj.resetMaterial(MObj);
  MObj.setMaterial(107,"41In",
      " 49113"+ext+"  1.5568E-03 "
      " 49115"+ext+"  3.4731E-02 ",
		     "",MLib);

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(108,"41AlHolder",
    " 13027"+ext+"  6.0261E-02 ",
 		     "",MLib);

  DBObj.resetMaterial(MObj);
  MObj.setMaterial(109,"41AlDet",
  " 13027"+ext+"  6.1308E-02 ",
 		     "",MLib);
  DBObj.resetMaterial(MObj);

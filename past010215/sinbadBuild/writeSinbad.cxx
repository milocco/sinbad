  ...
  */
{
  ...
  // IParam.regDefItem<int>("sdefType","sdefType",1,0);
...
namespace sinbadSystem
{
  ...
  cellI1(A.cellI1),cellI2(A.cellI2),WFlag(A.WFlag),DT1(A.DT1),DT2(A.DT2)
  /*!
    Copy constructor
   ...
   */
{
  ...
  // detector pile up
  if(IParam.getValue<std::string>("axDet",1)=="" && IParam.getValue<std::string>("axDet",1)!="Mn")
  WType="neutral";
  
  if(IParam.getValue<std::string>("vertDet",1)=="" && IParam.getValue<std::string>("vertDet",1)!="Mn")
  WType="neutral";
	   ...
	   if(Control.EvalVar<double>(detKey+"Active"+YIndex)==1)
	    {
	     ...
	     ELog::EM<<" detF "<<detFlag<<" "<<cellOffset<<ELog::endDiag;
	     double RD(0.0);
 ...
 ELog::EM<<" CO3 "<<cellOffset<<ELog::endDiag;
  ...
  */
{
  ...
  //  ELog::EM<< "WWW "<<WM.write()<<ELog::endDiag;
   ...
   */
{
 ...
 int LL(0);
  ...
  if(s101!=" ")
   ...
   StrFunc::writeMCNPX(" f104:n ("+s101+" )",OX);
   }
  ...
  if(s103!=" ")
   {
    ...
    StrFunc::writeMCNPX(" f114:n ("+s103+" )",OX);
  ...
  if(s104!=" ")
   {
    ...
    StrFunc::writeMCNPX(" f124:n ("+s104+" )",OX);
  ...
  if(s105!=" ")
   {
    ...
    StrFunc::writeMCNPX(" f134:n ("+s105+" )",OX);
   }

  if(s107!=" ")
   {
    StrFunc::writeMCNPX(" f144:n ("+s107+" )",OX);

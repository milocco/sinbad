...
setItemRotate(const attachSystem::FixedComp& WMaster,
  ...
  */
{
  ELog::RegMethod RegA("sinbadPhysics[F]","setItemRotate");
...
setDefRotation(const mainSystem::inputParam& IParam)
   ...
   */
{
  ELog::RegMethod RegA("sinbadPhysics[F]","setDefRotation");
...
setPhysicsModel(physicsSystem::LSwitchCard& lea,
  ...
  */
{
  ELog::RegMethod RegA("sinbadPhysics[F]","setPhysicsModel");
...
setDefaultPhysics(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("sinbadPhysics","setDefaultPhysics");
